% Function: getOverallPrev_fromAgeCurves.m
%  
% Description: 
%   Calculates the overall community-level mf prevalence from a single 
%   model-predicted mf prevalence age curve
%
% Inputs:
%   mPrevVal (a single column from mfPrevArray), demog, da, ageMthMax
%
% Outputs:
%   Returns mfPrevGroup, a single overall mf prevalence value for the given
%   model-predicted mf age prevalence curve
