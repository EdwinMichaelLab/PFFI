% Function: calcL3Fun_Oncho_exmort
%  
% Description: 
%       Function to calculate the value of L3 given the mf intensity
%       (mVec) and vector genus. See Gambhir and Michael 2008.
%
% Inputs:
%       mVec,beta,k0,kLin,k1,r1,sigma1,psi1,b1,k2,gam2,tau,demoX,ageMthMax,
%       da,ageLev,bCulex,larvaeDeath,excessMortality
%
% Outputs:
%       l3
