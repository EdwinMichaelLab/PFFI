...
Run the file setup_Vars.m, this will create input files for BaselineFitting.
...
IN :
    ...
    nor should they be directly handled or moved. BaselineFitting will 
    look to this folder to grab these inputs.

OUT :
    All files within OUT/ are created by running the Main procedure for 
    BaselineFitting. These files are then, if necessary, grabbed by the next 
    step of the overall process. In this way, the OUT/ directory is both an 
    input and an output directory. This directory should not be directly 
    edited by a user.
